...
export default function FormPlanoScreen() {
  ...
  return (
    <LayoutBase 
      ...
      subtitle={isEdit ? "Atualizar informações do plano" : "Criar novo plano de assinatura"}
    >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.row}>
              ...
              <View style={[styles.inputGroup, { flex: 1 }]}>
                <Text style={styles.label}>Checkins/Semana *</Text>
                <TextInput
            ...
            <View style={styles.inputGroup}>
              <View style={styles.switchRow}>
                <View>
                  <Text style={styles.label}>Disponível para Novos Contratos</Text>
                  <Text style={styles.switchSubtext}>
                    {formData.atual 
