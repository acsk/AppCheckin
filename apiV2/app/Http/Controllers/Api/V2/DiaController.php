...
class DiaController extends Controller
{
    ...
    public function horarios(Request $request, int $diaId): JsonResponse
    {
        ...
        $result = $this->service->horarios($diaId, $tenantId);
    ...
    public function horariosPorData(Request $request): JsonResponse
    {
        ...
        $result = $this->service->horariosPorData($tenantId, is_string($data) ? $data : null);
